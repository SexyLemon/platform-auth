 ...
 */
@Stateful
@Local(JpaUserStorageProvider.class)
public class JpaUserStorageProvider implements UserStorageProvider,
        UserLookupProvider,
    ...
    private static final Logger logger = Logger.getLogger(JpaUserStorageProvider.class);
    @PersistenceContext
